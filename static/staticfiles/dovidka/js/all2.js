...
DR_EXPLAIN.dataManager = (function() {
    ...
    var getPageFilename = function() {
        if ( window[ 'drex_file_name' ] !== undefined ) {
            // console.log(window.drex_file_name)
...
DR_EXPLAIN.searchEngine = (function() {
    ...
    */
    ...
    function ID()
    {
        ...
        var sID = "http://localhost:8000/static/staticfiles/dovidka/de_search/ids.json";
    ...
    function SearchForNextString()
    {
        ...
        var sURL = "http://localhost:8000/static/staticfiles/dovidka/de_search/"+StringPairArray[iStringToSearch][1];
    ...
    function GetIndex()
    {
        ...
        var sURL = "http://localhost:8000/static/staticfiles/dovidka/de_search/prefixes.json";
